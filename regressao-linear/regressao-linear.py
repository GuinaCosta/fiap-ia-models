...
# here we have 2 variables for
# multiple regression. If you just want to use one variable for simple linear
#regression, then use X = df['Interest_Rate'] for example.Alternatively, you
